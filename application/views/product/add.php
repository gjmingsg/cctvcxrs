...
?>
	...
	<table  border="0" cellpadding="3" cellspacing="0" >
		<tr>
			<th width="20%">产品名称：</th>
			<td>
			<?php echo form_input('ProductName',set_value('ProductName'),'id="ProductName" maxlength="15" class="required"');?>
			</td>
		</tr>
		<tr>
			<th>产品价格(元)：</th>
			<td>
			<?php echo form_input('Price',set_value('Price'),'id="Price" maxlength="10" class="required"');?>
			</td>
		</tr>
		<tr>
			<th>产品描述：</th>
			<td>
			<?php echo form_textarea('Description',set_value('Description'),'id="Description"  style="width:700px;height:200px;visibility:hidden;"');?>
			</td>
		</tr>
		<tr>		
			<td colspan="2">
