...
$db['dev']['password'] = 'pass@word1';
$db['dev']['database'] = 'cctvcxrs';
...
$db['default']['hostname'] = 'bdm-033.hichina.com';
$db['default']['username'] = 'bdm0330125';
$db['default']['password'] = 'inmyway789';
$db['default']['database'] = 'bdm0330125_db';
